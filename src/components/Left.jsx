  ...
  return (
    <div className=" w-[50%] p-5 h-full relative block bg-blue-900 rounded-md shadow-2xl shadow-blue-600  ">
        ...
        <div className="intro p-2 mt-5 mb-5 ">
            <h1></h1>
            <h1 className='text-white p-3 text-[24px] font-[400] ml-10 mt-8 '>The passage experienced a surge in popularity <br /> during the 1960s when Letraset used it on their <br /> dry-transfer sheets, and again during the 90s as <br /> desktop publishers bundled the text with their <br /> software.</h1>
